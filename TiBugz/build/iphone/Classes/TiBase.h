...
// in simulator we redefine to format for Bugz Developer console
...
{\
	NSString * exceptionName = [@"org.bugz." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bugz";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIBugzNativeItemNone = -1, 
	UIBugzNativeItemSpinner = -2,
	UIBugzNativeItemProgressBar = -3,
	
	UIBugzNativeItemSlider = -4,
	UIBugzNativeItemSwitch = -5,
	UIBugzNativeItemMultiButton = -6,
	UIBugzNativeItemSegmented = -7,
	
	UIBugzNativeItemTextView = -8,
	UIBugzNativeItemTextField = -9,
	UIBugzNativeItemSearchBar = -10,
	
	UIBugzNativeItemPicker = -11,
	UIBugzNativeItemDatePicker = -12,
	
	UIBugzNativeItemInfoLight = -13,
	UIBugzNativeItemInfoDark = -14,
	
	UIBugzNativeItemDisclosure = -15,
	
	UIBugzNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all Bugz instances of
