 ...
 * Copyright (c) 2009-2011 by Bugz, Inc. All Rights Reserved.
...
//@interface BugzObject : NSObject
//@end

@interface BugzObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BugzObject class]])
		{
			for (NSString *key in [[(BugzObject*)o modules] allKeys])
			{
